...
stripe.api_key = os.getenv("STRIPE_SECRET_KEY", "LLAVE_FALTANTE")
STRIPE_PRICE_MENSUAL = os.getenv("STRIPE_PRICE_MENSUAL_ID", "ID_FALTANTE")
STRIPE_PRICE_ANUAL = os.getenv("STRIPE_PRICE_ANUAL_ID", "ID_FALTANTE")
...
# =====================================================================
# 🌐 PORTAL COMERCIAL - LOGO T&B GLOBAL + MUNDO 3D CON SATÉLITES
# =====================================================================
if st.session_state["auth_rol"] is None:
    st.markdown("""
        <div class='logo-header' style='text-align: center; border-left: none; border-bottom: 4px solid #0284c7;'>
