...
# 2. INYECCIÓN DE ESTILOS PREMIUM (CONSERVA EL FORMATO CORPORATIVO AZUL)
st.markdown("""
<style>
    .brand-container {
...
if st.session_state["usuario_activo"] is None:
    ...
    # ---- CONSOLA DE CAPACIDAD COMPLETA TOTAL (TODO VISIBLE CONTINUO) ----
    ...
    # Formulario para aprovisionamiento desplegado (sin expander para máxima visibilidad)
    st.markdown("<br>", unsafe_allow_html=True)
    st.write(f"⚙️ **{L['open_c']}**")
