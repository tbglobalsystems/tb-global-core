...
if st.session_state["auth_rol"] is None:
    ...
    with col_centro:
     html_mundo_3d = """<div style="display: flex; justify-content: center; alig  
...
<script>
    ...
    function renderSistema() {
        ...
        const tierras = [[-45, -35, 30], [30, -45, 35], [-20, 30, 40], [-60, 15, 15]];
        tierras.forEach(t => { ctx.beginPath(); ctx.arc(t, t, t, 0, Math.PI * 2); ctx.fill(); });
        ctx.restore();
