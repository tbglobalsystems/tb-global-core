...
if st.session_state["usuario_activo"] is None:
    # Cargar traducción temporal solo para el login bloqueado
    ...
    with st.sidebar:
        ...
        p = st.text_input(f"{L['pin'] if 'pin' in globals() else 'PIN'}:", type="password", max_chars=4)
    ...
    # CARGAR TRADUCCIÓN GLOBAL ÚNICAMENTE CUANDO LA SESIÓN ESTÁ ACTIVA
