...
if st.session_state["usuario_activo"] is None:
    ...
    with st.expander("📈 Visualizar Monitor de Carga y Tráfico Cuántico", expanded=True):
        ...
        # Simulación de tráfico en gráfico nativo corregido sin operadores rotos
        valores_peticiones = [120, 240, 180]
        ...
        chart_data = pd.DataFrame({
            ...
            'Peticiones/Min': valores_peticiones[:total_nodos]
        })
