...
if st.session_state["usuario_activo"] is None:
    ...
    with st.sidebar:
        ...
        # 📂 BÓVEDA DE DOCUMENTOS INTEGRADA DIRECTO PARA EL PROPIETARIO
        st.markdown("---")
    ...
    # ---- CONSOLA DE CAPACIDAD COMPLETA OPERATIVA ----
    ...
    # CONSOLA PARA REGISTRAR NUEVOS SERVIDORES (Estructura plana sin st.form para evitar errores de identación)
    st.markdown("---")
