...
# Inicializar estados de la sesión originales
...
# CONTROL DE ACCESO ORIGINAL (EL PIN DE OPERADOR ESTABLECIDO)
...
# BARRA LATERAL OPERATIVA (BÓVEDA DE DOCUMENTOS)
with st.sidebar:
...
# ---- CONSOLA DE INTERFAZ SECUENCIAL DE CAPACIDAD COMPLETA ----

# ÁREA 1: TELEMETRÍA Y MAPA COMPACTADO (OBLIGA A LAS ÁREAS 2 Y 3 A ENTRAR EN PANTALLA)
st.markdown(f"#### {L['area1']}")
st.map(st.session_state["nodos"], zoom=1, use_container_width=True, height=250)

# CONTROLES DE ENFOQUE DEL MAPA (CON SU ANCHO COMPLETO ORIGINAL)
