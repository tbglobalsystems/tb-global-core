...
<script>
    ...
    function renderSistema() {
        ...
        // 1. BRILLO ATMOSFÉRICO (Glow Neón)
        ...
        // 2. CUERPO DEL OCÉANO (Efecto Esférico)
        ...
        // 3. CONTINENTES EN ROTACIÓN (Relieve)
        ctx.save();
        ...
        // 4. CAPA DE SOMBRA (Efecto Esfera 3D)
        ...
        ctx.beginPath(); ctx.arc(satAX, satAY, 4, 0, Math.PI * 2); ctx.fill();
        ...
        // 6. SATÉLITE QUANTUM BETA Y ENLACES
