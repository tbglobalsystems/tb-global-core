...
# CONTROL DE ACCESO ORIGINAL DE LA PLATAFORMA (TU LOGIN INALTERADO)
    ...
    with st.sidebar:
        ...
        if st.button("Validar Credenciales"):
            if u and p:
                ...
                st.rerun()
    st.stop()  # Detiene la carga limpia si no hay autenticación válida para proteger la interfaz
...
# CONSOLA PARA REGISTRAR NUEVOS SERVIDORES (Abierta y visible de forma fija)
st.markdown("---")
