...
# MATRIZ DE TRADUCCIÓN COMPACTA NATIVA (CON LAS LLAVES ALINEADAS EN AMBOS IDIOMAS)
IDIOMAS = {
    "es": {
...
<style>
    ...
    /* Regla Maestra de Color Azul para todos los botones */
    .stButton>button {
        width: 100% !important;
...
if st.session_state["usuario_activo"] is None:
    ...
    with st.sidebar:
        ...
        # 📂 BÓVEDA DE DOCUMENTOS INTEGRADA DIRECTO EN EL PROGRAMA PARA EL DUEÑO
        st.markdown("---")
