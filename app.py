...
# LOGIN CENTRALIZADO FIJO EN LA PANTALLA PRINCIPAL PARA TABLETAS
...
# BARRA LATERAL CON DOCUMENTOS (APARECE SOLO AL LOGUEARSE)
with st.sidebar:
...
# INTERFAZ DE CAPACIDAD COMPLETA CONTINUA
