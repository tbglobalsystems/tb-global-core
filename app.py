...
IDIOMAS = {
    "es": {
        ...
        "monitor": "📈 Monitor de Carga y Tráfico Cuántico",
...
# Inicializar estados de la sesión usando la estructura limpia original
...
# CONTROL DE ACCESO ORIGINAL (EL PIN QUE YA TIENES CONFIGURADO)
...
# ---- DISTRIBUCIÓN INTEGRAL EN PARALELO (GRID HORIZONTAL FIJO DE DOS COLUMNAS) ----
col_izquierda, col_derecha = st.columns([1.1, 0.9], gap="large")

# COLUMNA IZQUIERDA: ÁREA 1 (MAPA Y ENFOQUE)
with col_izquierda:
