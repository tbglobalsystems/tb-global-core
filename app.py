...
# ---- INTERFAZ PLANO-SECUENCIAL CONTINUA (OBLIGA A RENDERIZAR TODO DE CORRIDO) ----
...
with col_t1: st.metric(label=L["m1"], value="3 / 12 Nodes")
with col_t2: st.metric(label=L["m2"], value="135 Gbps Assigned")
with col_t3: st.metric(label=L["m3"], value="18 ms Mean Latency")
...
csv_logs = LOGS_ESTATICOS.to_csv(index=False).encode('utf-8')
st.download_button(
